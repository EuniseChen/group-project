...
question_2.addEventListener('click', () => {
  ...
  QnA(
    `那我想請問認養有甚麼身份資格的限制嗎？`,
    `我們並不會禁止情侶或是學生領養喔，但是學生的話會需要您先
  跟家長溝通，家長同意後也會讓您挑選心愛的毛孩帶回家喔！`,
    `雖然本店認養上沒有身份資格的限制，但希望所有確定要認養的
  主人們，都一定要有一個能夠為你領養的毛孩，負責一輩子的決心喔`
  )
  us_2.style.display = 'none'
})
...
question_3.addEventListener('click', () => {
  ...
  QnA(
    `那在領養上，還有甚麼我必須注意的事情嗎？`,
    `希望您在七天的冷靜期能可以先好好卸下衝動後，冷靜思考你真的準備好了嗎？這不是幾個月甚至幾年而已，你未來的所有規劃
  都必須多考慮一個生命喔！`,
    `而且在一週冷靜期中有問題都可以隨時跟老闆聯繫，或覺得您已
  經準備好了，請主動打電話告知老闆，在思考後還是決定想要領
  養牠的認養人，才會是我們未來的親家喔！最後無論有沒有跟我
  們領養，都是很棒的事！我們會很期待接到您的提親電話！`
  )
  us_2.style.display = 'none'
})

function QnA(fromCustomer, fromUs, fromUs2) {
  typing(customer, us_1, us_2, fromCustomer, fromUs, fromUs2)
}

function typing(customer, us_1, us_2, fromCustomer, fromUs, fromUs2) {
  ...
  timer_us_1 = setTimeout(() => (us_1.innerHTML += fromUs), 1000)
